...
function NewsletterForm() {
  ...
  if (done) {
    return (
      <div style={{ fontSize: 13, fontWeight: 700, color: '#10b981', background: 'rgba(16,185,129,0.1)', border: '1px solid rgba(16,185,129,0.25)', padding: '10px 16px', borderRadius: 10 }}>
  ...
  return (
    <form
      ...
      style={{ display: 'flex', gap: 8, flexWrap: 'wrap', maxWidth: 400 }}
    >
      <input
        type="email"
        required
        ...
        onBlur={e => { e.target.style.borderColor = 'rgba(51,102,255,0.25)'; }}
      />
      <button
        type="submit"
        style={{
        ...
        onMouseEnter={e => { e.currentTarget.style.background = '#2952cc'; }}
