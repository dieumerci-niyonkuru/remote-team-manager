    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Create New Workspace">
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="flex justify-center mb-8">
           <div className="w-20 h-20 rounded-3xl bg-blue-600/10 border-2 border-blue-600/20 flex items-center justify-center text-blue-500">
              <Briefcase size={40} />
           </div>
        </div>
        ...
        <div>
          ...
          <input 
            ...
            className="w-full bg-[#060b18] border border-gray-800 rounded-2xl px-4 py-3.5 text-white outline-none focus:border-blue-500 transition-all font-medium"
          />
        </div>
