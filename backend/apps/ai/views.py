...
class AISuggestionViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        return Response({"message": "Use POST to get suggestions"})

    def create(self, request):
        # reuse the logic from SuggestTasksView if needed or just return a placeholder
        return Response({"status": "Suggestion generated"})
