...
# Patched v4: cross-database compatible (PostgreSQL + SQLite)
...
def create_chat_tables(apps, schema_editor):
    ...
    if vendor == 'postgresql':
        ...
        # SQLite-compatible DDL (no CASCADE, no bigserial, no timestamptz, no DEFERRABLE)
        for tbl in [
            ...
            schema_editor.execute(f'DROP TABLE IF EXISTS "{tbl}"')
