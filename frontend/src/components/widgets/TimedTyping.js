...
const TimedTyping = () => {
  ...
  const [finalWordCount, setFinalWordCount] = useState(null);
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
      ...
      <div className="flex gap-3 items-center mb-4">
        <input type="number" min="1" value={timeMinutes} onChange={e => setTimeMinutes(parseInt(e.target.value))} className="border rounded p-2 w-24" disabled={isActive} />
        <span>minutes</span>
      ...
      {!isActive && finalWordCount !== null && <div className="text-lg font-bold text-purple-600 mb-2">You wrote {finalWordCount} words!</div>}
