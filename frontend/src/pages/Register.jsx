      ...
      <div className="card fade-in" style={{ width: '100%', maxWidth: 480, padding: 40 }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div>
            ...
            {form.password && (
              <>
                <div className="password-strength" style={{ width: `${strength.score * 33}%`, background: strength.color, height: 4, borderRadius: 4, marginTop: 6 }} />
                <div className={`password-strength-text ${strength.class}`} style={{ fontSize: 11, marginTop: 4 }}>
